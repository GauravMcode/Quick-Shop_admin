...
ThemeData themeData() {
  return ThemeData(
    ...
    scaffoldBackgroundColor: const Color(0xffced6e0),
    appBarTheme: const AppBarTheme(color: Color(0xffffa502), centerTitle: true, titleTextStyle: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      labelStyle: TextStyle(color: Color(0xffffa502)),
    ...
    // drawerTheme: const DrawerThemeData(backgroundColor: Color(0xff2f3542)),
